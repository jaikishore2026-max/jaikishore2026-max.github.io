...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Story', href: '#timeline', id: 'timeline' },
  ...
  return (
    <>
      ...
      <nav className={`fixed top-0 left-0 w-full z-40 transition-all duration-500 ${
        ...
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            {portfolioData.socials.github && (
              <a
                ...
                className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-accent-indigo/10 transition-all duration-300"
              >
            ...
            {portfolioData.socials.instagram && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-pink-500/10 transition-all duration-300"
              >
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg text-gray-400 hover:text-white transition-colors focus:outline-none"
          >
      ...
      {/* Mobile Drawer */}
      <div className={`fixed inset-y-0 right-0 w-64 bg-bg-deep/95 border-l border-border-glass backdrop-blur-xl z-30 p-8 transform transition-transform duration-300 lg:hidden ${
            ...
            <div className="flex space-x-3 justify-center">
              {portfolioData.socials.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white p-2 rounded-lg border border-border-glass hover:border-accent-cyan/50 transition-all duration-300"
                >
                  <Github className="w-5 h-5" />
                </a>
              )}
              {portfolioData.socials.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white p-2 rounded-lg border border-border-glass hover:border-pink-400/50 transition-all duration-300"
                >
                  <Instagram className="w-5 h-5" />
                </a>
              )}
